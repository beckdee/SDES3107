...
void setup() { 
  ...
  img=loadImage("andy1.png");
  img2=loadImage("andy2.png");
} 
...
void draw() { 
  ...
  color a = get(mouseX-100, mouseY-100);
  color b = get (mouseX/2, mouseY/2);
  color c = get (mouseX-50, mouseY-50);
  smooth();
  fill(b);
  background(a); 
  stroke(c);
